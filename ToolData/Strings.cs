...
public static class Strings
{
    ...
    public const string ModifierVersion = "5.3.1";
    ...
    public static string GetGameVersion(string gameHash)
    {
        return gameHash switch
        {
    ...
    public const string PlantSpeedMultiplier = "PlantSpeedMultiplier";
    public const string PlantAttackMultiplier = "PlantAttackMultiplier";
    public const string PlantHealthMultiplier = "PlantHealthMultiplier";
    public const string SetPlantSpeedRatio = "SetPlantSpeedRatio";
    public const string SetPlantAttackRatio = "SetPlantAttackRatio";
    public const string SetPlantHealthRatio = "SetPlantHealthRatio";
