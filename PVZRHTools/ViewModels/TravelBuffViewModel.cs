...
public partial class TravelBuffViewModel : ModifierPageViewModelBase
{
    ...
    public void AdvBuffChooseAll()
    {
        DataSyncService.Lock(true);
        IsChangingAll = true;
        foreach (var advBuff in AdvBuffs) advBuff.Level = 1;
    ...
    public void AdvBuffDeselectAll()
    {
        DataSyncService.Lock(true);
        IsChangingAll = true;
        foreach (var advBuff in AdvBuffs) advBuff.Level = 0;
    ...
    public void InGameAdvBuffChooseAll()
    {
        DataSyncService.Lock(true);
        IsChangingAll = true;
        foreach (var advBuff in InGameAdvBuffs) advBuff.Level = 1;
    ...
    public void InGameAdvBuffDeselectAll()
    {
        IsChangingAll = true;
        DataSyncService.Lock(true);
        foreach (var advBuff in InGameAdvBuffs) advBuff.Level = 0;
    ...
    public void UltiBuffDeselectAll()
    {
        IsChangingAll = true;
        DataSyncService.Lock(true);
        foreach (var ultiBuff in UltiBuffs) ultiBuff.Level = 0;
    ...
    public void InGameUltiBuffChooseAll()
    {
        DataSyncService.Lock(true);
        IsChangingAll = true;
        foreach (var ultiBuff in InGameUltiBuffs) ultiBuff.Level = 1;
    ...
    public void InGameUltiBuffDeselectAll()
    {
        DataSyncService.Lock(true);
        IsChangingAll = true;
        foreach (var ultiBuff in InGameUltiBuffs) ultiBuff.Level = 0;
    ...
    public void DebuffChooseAll()
    {
        DataSyncService.Lock(true);
        IsChangingAll = true;
        foreach (var debuff in Debuffs) debuff.Enabled = true;
    ...
    public void DebuffDeselectAll()
    {
        DataSyncService.Lock(true);
        IsChangingAll = true;
        foreach (var debuff in Debuffs) debuff.Enabled = false;
    ...
    public void InGameDebuffChooseAll()
    {
        DataSyncService.Lock(true);
        IsChangingAll = true;
        foreach (var debuff in InGameDebuffs) debuff.Enabled = true;
    ...
    public void InGameDebuffDeselectAll()
    {
        IsChangingAll = true;
        DataSyncService.Lock(true);
        foreach (var debuff in InGameDebuffs) debuff.Enabled = false;
    ...
    {
        DataSyncService.Lock(true);
        foreach (var invest in InvestBuffs) invest.Enabled = true;
    ...
    public void InvestBuffDeselectAll()
    {
        DataSyncService.Lock(true);
        IsChangingAll = true;
        foreach (var invest in InvestBuffs) invest.Enabled = false;
    ...
    public void InGameInvestBuffChooseAll()
    {
        DataSyncService.Lock(true);
        IsChangingAll = true;
        foreach (var invest in InGameInvestBuffs) invest.Enabled = true;
    ...
    public void InGameInvestBuffDeselectAll()
    {
        DataSyncService.Lock(true);
        IsChangingAll = true;
        foreach (var invest in InGameInvestBuffs) invest.Enabled = false;
    ...
    public void UnlockedPlantChooseAll()
    {
        DataSyncService.Lock(true);
        IsChangingAll = true;
        foreach (var plant in UnlockedPlants) plant.Enabled = true;
    ...
    public void UnlockedPlantDeselectAll()
    {
        DataSyncService.Lock(true);
        IsChangingAll = true;
        foreach (var plant in UnlockedPlants) plant.Enabled = false;
    ...
    public void InGameUnlockedPlantChooseAll()
    {
        DataSyncService.Lock(true);
        IsChangingAll = true;
        foreach (var plant in InGameUnlockedPlants) plant.Enabled = true;
    ...
    public void InGameUnlockedPlantDeselectAll()
    {
        DataSyncService.Lock(true);
        IsChangingAll = true;
        foreach (var plant in InGameUnlockedPlants) plant.Enabled = false;
