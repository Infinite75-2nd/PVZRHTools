...
public static class SuperThreeGatlingPatch
{
    ...
    public static void PreUpdate(SuperThreeGatling __instance, out bool __state)
    {
        __state = false;
    ...
    [HarmonyPostfix]
    [HarmonyPatch(nameof(SuperSnowGatling.Update))]
    public static void PostUpdate(SuperThreeGatling __instance, bool __state)
    {
    ...
    public static void PostShoot1(SuperThreeGatling __instance)
    {
