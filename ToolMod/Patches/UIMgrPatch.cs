...
public static class UIMgrPatch
{
    ...
    public static void PostEnterMainMenu()
    {
        ...
        text1.text =
            $"PVZRHTools {Strings.GameVersion}-{Strings.ModifierVersion}\n作者@Infinite75@梧萱梦汐X@墨染荷韵\n已加载{IL2CPPChainloader.Instance.Plugins.Count}个Mod";
    ...
    public static void PostEnterChallengeMenu()
    {
        try
        {
            var abyss = GameObject.Find("FirstBtns").transform.GetChild(9).gameObject;
            abyss.active = true;
